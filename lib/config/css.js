...
module.exports = (api, options) => {
  api.chainWebpack(webpackConfig => {
    ...
    createCSSRule('scss', /\.scss$/, 'sassjs-loader', Object.assign(defaultSassLoaderOptions, loaderOptions.sass))
    createCSSRule('sass', /\.sass$/, 'sassjs-loader', Object.assign(defaultSassLoaderOptions, {
      indentedSyntax: true
    }, loaderOptions.sass))
